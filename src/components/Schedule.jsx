  ...
  return (
    <div className="text-center w-[100%]">
        <div className="flex flex-col items-center lg:flex-row justify-center gap-12">
          <div className="card-shadow bg-gray-700 w-[300px] lg:max-w-[300px] rounded-xl hover:bg-gray-900 hover:scale-110 duration-700 p-5" data-aos="zoom-in" data-aos-duration="900">
          ...
          <div className="card-shadow bg-gray-700 w-[300px] lg:max-w-[300px] rounded-xl hover:bg-gray-900 hover:scale-110 duration-700 p-5" data-aos="zoom-in" data-aos-duration="800">
            <figure className="w-24 h-24 p-2 rounded-md mx-auto">
              <img src={Plane} alt="" className="shadow-white w-full" />
            </figure>
