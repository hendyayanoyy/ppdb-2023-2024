...
<div className='absolute w-full top-1/2 left-1/2 transform -translate-x-1/2 text-shadow2 text-lg md:text-3xl lg:text-4xl tracking-tight text-white'>
  <p>
    Untuk calon pendaftar masuk SMP Mitra Bintaro Islamic School tahun ajaran 2024/2025
    bisa mendaftar lewat website ini
    atau langsung datang ke SMP Mitra Bintaro Islamic School
  </p>
</div>
      ...
      <img src={hero} alt="" className="shadow-white w-full h-screen object-cover" />
    </div>
  );
}
