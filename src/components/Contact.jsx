...
function Contact() {
  return (
    <div className="text-white">
      ...
      <div className="bg-[#F33E3E] pb-12 px-4 md:px-12"> {/* Tambahkan md:px-12 */}
        <div className="flex font-semibold text-sm md:text-xl lg:text-xl gap-4 lg:flex-col flex-col max-w-[50%] rounded-[12px] bg-[rgba(0,0,0,0.3)] p-4 md:p-12"> {/* Tambahkan p-4 dan md:p-12 */}
          ...
          <p className="text-md font-normal px-4 md:px-0 lg:px-0 md:text-lg lg:text-lg text-left text-gray-200"> {/* Tambahkan px-4 */}
      ...
      <div className="maps absolute md:bottom-24 right-4 md:right-10 w-full md:w-[40%] h-[50vh] md:h-[78vh]">
        <iframe
          title="Google Maps"
