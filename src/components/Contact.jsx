...
function Contact() {
  return (
    <div>
      ...
      <h2 className='font-bold text-3xl bg-black text-white py-2'>HUBUNGI KAMI</h2>
      <hr className='border-b-2 border-red-500 my-1' />
      ...
      <div className='flex justify-center font-semibold text-xl gap-10 px-4 lg:px-24 py-20 lg:flex-row flex-col items-center'>
        ...
        <div className='icon flex flex-col font-bold items-center lg:mb-0 mb-6'>
          ...
          <div className='mt-2'>
          <a href="https://wa.me/6281234567890" className='hover:text-red-500'>082169462242 </a><span>/ </span>
          <a href="https://wa.me/6287809270299" className='hover:text-red-500'>087809270299 </a><span>/ </span>
          <a href="https://wa.me/6289513606272" className='hover:text-red-500'>089513606272</a>
          </div>
        </div>
